                ...
                <div class="hijo">
                    <% for (Asignatura asignatura: asignaturasUsuario11) { %>
                        <%if(asignatura.getTipo().equals("Formacion Basica")){%>
                            <a href="<%= request.getContextPath() %>/recomendador?asignatura=<%=asignatura.getNombre()%>&id=<%=asignatura.getId()%>" class="asignatura" style="background-color: rgb(65, 179, 228)" 
                        ...
                        <%}else if(asignatura.getTipo().equals("Obligatoria")){%>
                            <a href="<%= request.getContextPath() %>/recomendador?asignatura=<%=asignatura.getNombre()%>&id=<%=asignatura.getId()%>" class="asignatura" style="background-color: rgb(74, 91, 224)" 
                                data-nombre="<%= asignatura.getNombre() %>" data-participacion="<%= asignatura.getParticipacion() %>" data-nota="<%= asignatura.getNota() %>" 
                                data-asistencia="<%= asignatura.getAsistencia() %>" data-notamedia="<%= asignatura.getNotaMedia() %>" data-participacionmedia="<%= asignatura.getParticipacionMedia() %>"
                                data-asistenciamedia="<%= asignatura.getAsistenciaMedia() %>">
                                <h3><%= asignatura.getNombre() %></h3>
                        ...
                        <%}else if(asignatura.getTipo().equals("Optativa")){%>
                            <a href="<%= request.getContextPath() %>/recomendador?asignatura=<%=asignatura.getNombre()%>&id=<%=asignatura.getId()%>" class="asignatura" style="background-color: rgb(224, 164, 74)" 
                                data-nombre="<%= asignatura.getNombre() %>" data-participacion="<%= asignatura.getParticipacion() %>" data-nota="<%= asignatura.getNota() %>" 
                                data-asistencia="<%= asignatura.getAsistencia() %>" data-notamedia="<%= asignatura.getNotaMedia() %>" data-participacionmedia="<%= asignatura.getParticipacionMedia() %>"
                                data-asistenciamedia="<%= asignatura.getAsistenciaMedia() %>">
                                <h3><%= asignatura.getNombre() %></h3>
                        ...
                        <%}else{%>
                            <a href="<%= request.getContextPath() %>/recomendador?asignatura=<%=asignatura.getNombre()%>&id=<%=asignatura.getId()%>" class="asignatura" style="background-color: rgb(135, 60, 30)" 
                                data-nombre="<%= asignatura.getNombre() %>" data-participacion="<%= asignatura.getParticipacion() %>" data-nota="<%= asignatura.getNota() %>" 
                                data-asistencia="<%= asignatura.getAsistencia() %>" data-notamedia="<%= asignatura.getNotaMedia() %>" data-participacionmedia="<%= asignatura.getParticipacionMedia() %>"
                                data-asistenciamedia="<%= asignatura.getAsistenciaMedia() %>">
                                <h3><%= asignatura.getNombre() %></h3>
