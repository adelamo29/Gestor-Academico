...
@WebServlet("/busquedaEstudiante")

public class BusquedaEstudiante extends HttpServlet{
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
        ...
        String nomEstudiante = request.getParameter("nombreEst");
        System.out.println(nomEstudiante);
        session.setAttribute("nomEstudiante", nomEstudiante);
        ...
        try(DBManager db = new DBManager()){ 
            ...
            List<Asignatura> asignaturasMatriculadas = db.buscarAsignaturasMatriculadas(estudiante.getId());
            ...
            for (Asignatura asignatura: asignaturasMatriculadas){
                ...
                nota_media = db.notaMediaAsignatura(asignatura.getNombre(), estudiante.getTitulacion());
                asignatura.setNotaMedia(nota_media);

                participacion_media = db.participacionMediaAsignatura(asignatura.getNombre(), estudiante.getTitulacion());
                asignatura.setParticipacionMedia(participacion_media);

                asistencia_media = db.asistenciaMediaAsignatura(asignatura.getNombre(), estudiante.getTitulacion());
            ...
            request.getRequestDispatcher("/jsp/busquedaEstudiante.jsp").forward(request, response);
